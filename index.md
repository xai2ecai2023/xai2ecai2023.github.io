...
|{::nomarkdown} Towards Explainable AI 2.0 (XAI 2.0)<br><text class="person">Przemysław Biecek</text> {:/}|{::nomarkdown} Explainable AI for Medical Applications (XAIM)<br><text class="person">Neo Christopher Chung</text> {:/}|{::nomarkdown} XAI for Industry 4.0 & 5.0 (XAI4I)<br><text class="person">Sławomir Nowaczyk</text> {:/}|
| --- | --- | --- |
