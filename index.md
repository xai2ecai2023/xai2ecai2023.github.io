...
|{::nomarkdown} <strong>Towards Explainable AI 2.0 (XAI 2.0)</strong></br>Przemysław Biecek {:/}|{::nomarkdown} <strong>Explainable AI for Medical Applications (XAIM)</strong></br>Neo Christopher Chung {:/}|{::nomarkdown} <strong>XAI for Industry 4.0 & 5.0 (XAI4I)</strong></br>Sławomir Nowaczyk {:/}|
| --- | --- | --- |
